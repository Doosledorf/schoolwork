<?php
    ...
    print_header("Major Players");
?>
				<h2>Major Players</h2>
				<div class = "info_panel">
					
					<img class = "infoImage" src = "Assets/images/People/major_players/alexstraza.jpg" alt ="Alexstraza"/>
						...
						<p>		Alexstrasza the Life Binder, Red Dragon Aspect, Head of the Wyrmrest Accord, Guardian of all Life in Azeroth and Queen of Dragons was appointed as such by the 
								Titans themselves. She and her followers avoid killing if possible, but will not shy away from bringing justice upon those whom deserve it. Her abilities lean towards
								healing and resurrection, though when on the offensive, she can morph into a fiery red dragon.</p>
				...
				<div class = "info_panel">
					...
					<img class = "infoImage" src = "Assets/images/People/major_players/malygos.jpg" alt ="Malygos"/>
						...
						<p>		Malygos the Blue Dragon Aspect, SpellWeaver, Hidden Arcanum and Guardian of Magic, leads a genocidal crusade against magic users and seeks to rein in the "unbridled"
								magic use throughout Azeroth via his Nexus in Coldarra. He was not always this way. Only after his bout with Deathwing eons prior, did he become 
						...
						<p> 	Malygos intends on using the Arcanomicon to find the world's magical leylines and divert them to his Nexus. </p>
					
				</div>
				
				<div class = "info_panel">
					
					<img class = "infoImage" src = "Assets/images/People/major_players/darion.jpg" alt ="Darion Morgraine"/>
				...
				<div class = "info_panel">
					...
					<img class = "infoImage" src = "Assets/images/People/major_players/tirion.jpg" alt ="Tirion Fordring"/>
				...
				<div class = "info_panel">
					...
					<img class = "infoImage" src = "Assets/images/People/major_players/jaina.jpg" alt ="Jaina Proudmoore"/>
					
					
						<h1>Jaina Proudmoore</h1>
						<p>		Founder of Theramore and member of the Kirin Tor, Jaina seeks to release Arthas, her lost love, from his Lich King-dom. After the events in the Halls of
								Reflection, Jaina finds that her wishes mean nothing and that the Lich King must be killed and replaced. </p>
					
				</div>
				
				<div class = "info_panel">
					
					<img class = "infoImage" src = "Assets/images/People/major_players/sylvanas.jpg" alt ="Sylvanas"/>
					
					
						<h1>Sylvanas</h1>
						<p>		Sylvanas is the leader of the Forsaken and Banshee Queen. The Lich King, then Arthas, destroyed her home, Quel'Thalas and killed her himself.
								She was then raised as an undead minion. She did regain her free will eventually and plotted her revenge against the Lich King and his Scourge.</p>
						<p> 	She does get her bout with the Lich King, but he proves far more powerful than she realized and was forced to amass and combine forces with her enemies, so that
				...
				<div class = "info_panel">
					...
					<img class = "infoImage" src = "Assets/images/People/major_players/arthas.jpg" alt ="Arthas"/>
					
					
						<h1>Arthas</h1>
						<p>		AKA the Lich King. This current incarnation of the Lich King is a result of a merge between Arthas and Ner'zhul, the original
								Lich King, now bound to the Frozen Throne.</p>
						<p>		Arthas was not always the Lich King. In fact, he was the opposite. He was a Knight of the Silver Hand and a Prince of Lordaeron, tutored by the great Uther the Lightbringer himself.
								After his futile attempts to save those at Stratholme, Arthas disbanded the Knights. The Culling of Stratholme would haunt him for all his days. His fate was sealed in finding Shadowmoune in Northrend. He returns to his hometown to kill his father, destroy Lordaeron, level Quel'Thas and evaporate Dalaran. He flees to Northrend to find the Frozen Throne. After wounding Illidan over it, Arthas sat on the throne and donned the Lich King's helmet, merging his mind
								with Ner'zhul's. </p>
				...
				<div class = "info_panel">
					...
					<img class = "infoImage" src = "Assets/images/People/major_players/bolvar.jpg" alt ="Bolvar Fordragon"/>
						...
						<p>		Bolvar Fordragon was a revered paladin and Commander of the Alliance Vanguard who was thought to have died initially at the Wrathgate--be that by plague or by fire.
								He wasn't. In fact he was taken in by the Scourge, his body badly burned and taken to the Lich King for torture. The Lich King could not break
								his will and Bolvar lasted until the his very demise. Bolvar Fordragon stopped Tirion from donning the helm of the Lich King, as
