var wardrobe =  { 
                 'Azazel': { imageFilePath : 'assets/images/char_images/Azazel.jpg',
                             ...
                             pickup : [ '0 - The Fool' ],
                             items : { 
                                     'Short Ranged Brimstone' : { imageFilePath : 'assets/images/item_images/brimstone.jpg', itemDescription : 'A very powerful blood beam. Release the fire button when fully charged.' },
                                     'Faux Lord of the Pit' : { imageFilePath : 'assets/images/item_images/lordOfThePit.jpg', itemDescriptiom : 'Grants flight.' }
                                     },
                 ...
                 'Magdalene' : { imageFilePath : 'assets/images/char_images/Magdalene.jpg', 
                                 ...
                                 pickup : [ 'None' ],
                                 items : { 'Yum Heart' : { imageFilePath : 'assets/images/item_images/yumHeart.jpg', itemDescription : 'Heals for one heart. 4x room charge.' } },
                 ...
                 'Cain' : { imageFilePath : 'assets/images/char_images/Cain.jpg', 
                            ...
                            pickup : [ '1x Key' ],
                            items : { 'Lucky Foot' : { imageFilePath : 'assets/images/item_images/luckyFoot.jpg', itemDescription : '+1 Luck. Increases chances of winning at Shell Game Beggar and Fortune Teller.' } },
                            unlock : 'Obtain more than 55 pennies in a single run.', 
                            comment : 'Fortune teller machines have never been more broken.', 
                            score : 0
                          }, 
    
                 'Judas' : { imageFilePath : 'assets/images/char_images/Judas.jpg',
                             ...
                             pickup : [ '3x Coins' ], 
                             items : { 'Book of Belial' : { imageFilePath : 'assets/images/item_images/bookOfBelial.jpg', itemDescription : '+2 Damage for the duration of the room. An additional 50% if holding Blood of the Matyr. Guarantees a devil/angel room if killing a boss holding it.' } },
                             unlock : 'Beat Satan.', 
                             comment : 'Guaranteed devil rooms?! Damage for days?! Sign me up.',
                             score : 0
                           },
    
                 '???' : { imageFilePath : 'assets/images/char_images/BlueBaby.jpg', 
                           ...
                           pickup : [ 'None' ],
                           items : { 'Poop' : { imageFilePath : 'assets/images/item_images/thePoop.jpg', itemDescription : 'You poop.' } },
                 ...
                 'Eve' : { imageFilePath : 'assets/images/char_images/Eve.jpg', 
                           stats : { hearts : { heartType : 'red', heartCount : 2 }, 
                                     speed : 2,
                                     range : 2, 
                                     tears : 1, 
                           ...
                           pickup : [ 'None' ],
                           items : {
                                                'Dead Bird' : { imageFilePath : 'assets/images/item_images/deadBird.jpg', itemDescription : 'When hit, abird appears to attack nearby enemies for the duration of the room.' }, 
                                                'Whore of Babylon' : { imageFilePath : 'assets/images/item_images/whoreOfBabylon.jpg', itemDescription : 'In the case of Eve, being reduced to one red heart or less gives you increased damage and speed.'}
                                   },
                 ...
                 'Samson' : { imageFilePath : 'assets/images/char_images/Samson.jpg', 
                           stats : { hearts : { heartType : 'red', heartCount : 3 }, 
                                     speed : 2,
                                     range : 4, 
                                     tears : 1, 
                           ...
                           pickup : [ 'None' ],
                           items : { 'Bloody Lust' : { imageFilePath : 'assets/images/item_images/bloodyLust.jpg', itemDescription : 'Killing enemies and taking damage permenantly increase your damage for the duration of the floor.' } },
                 ...
                 'Lazarus' : { imageFilePath : 'assets/images/char_images/Lazarus.jpg', 
                           stats : { hearts : { heartType : 'red', heartCount : 3 }, 
                                     speed : 2,
                                     range : 1, 
                                     tears : 1, 
                           ...
                           pickup : [ '1x Pill' ],
                           items : { 'Lazarus\'s Rags' : { imageFilePath : 'assets/images/item_images/lazarusRags.jpg', itemDescription : 'Upon death, the character respawns immediately as \'Revived Lazarus\'. This effect lasts for the duration of the run.' } },
                ...
                'Eden' : { imageFilePath : 'assets/images/char_images/Eden.jpg', 
                           ...
                           pickup : [ 'Varies' ],
                           items : { 
                                        'Random Item 1' : { imageFilePath : 'assets/images/item_images/random_D6.jpg', itemDescription : 'Depends on the Item' },
